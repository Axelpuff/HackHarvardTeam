...
export function ConversationPanel({
  ...
  return (
    <div className="conversation-panel rounded-lg shadow-sm h-96">
      <div className="p-4">
            ...
            <button
              onClick={() => {
                ...
                const transcriptText = transcript
                  .map(
                    (entry) =>
                      `[${formatTime(entry.timestamp)}] ${entry.role}: ${entry.text}`
                  )
                  .join('\n');
      ...
      <div className="flex flex-col h-80">
        ...
        <div
          ref={scrollRef}
          className="conversation-transcript-bg flex-1 overflow-y-auto p-4 space-y-3"
        >
          {transcript.length === 0 ? (
            <div className="text-center text-gray-500 dark:text-gray-400 mt-8">
              <p>Start a conversation to get scheduling assistance</p>
              <p className="text-sm mt-2">
                You can type or use voice input to describe your scheduling
                needs
              </p>
            </div>
          ) : (
                ...
                <div
                  className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${
                    entry.role === 'user'
                      ...
                      : 'bg-white/70 dark:bg-gray-900/60 shadow-sm backdrop-blur-sm'
                  }`}
                >
